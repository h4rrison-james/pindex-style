...
@sans_it: 'DIN Offc Pro Italic', @fallback;
...
#place_label::citydots[type='city'][zoom>=4][zoom<=7][localrank<=3] {
  ...
  [ldir='NE'],[ldir='SE'],[ldir='SW'],[ldir='NW'] {
    ...
    shield-fill: lighten(@water, 40);
    shield-halo-fill: fadeout(@water, 80%);
    shield-text-opacity: 0.8;
...
#place_label[zoom>=8][localrank<=3] {
  ...
  text-wrap-width: 120;
  text-wrap-before: true;
  text-fill: lighten(@water, 70);
  text-opacity: 0.8;
  text-halo-fill: fadeout(@water, 50%);
  text-halo-radius: 1;
  text-halo-rasterizer: fast;
  text-size: 10;
