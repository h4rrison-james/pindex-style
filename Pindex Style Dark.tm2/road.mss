...
@motorway:          @water;
@main:              lighten(@water, 5);
@street:            lighten(@water, 5);
@street_limited:    lighten(@water, 6);
...
#road, #bridge, #tunnel {
  ...
  ::fill[zoom>=6]['mapnik::geometry_type'=2] {
    ...
    [class='street'][zoom>=15], {
      line-join:round;
      #road, #bridge { line-cap: round; }
      [zoom>=15] { line-width:2.5; line-color:lighten(@water, 5); }
      [zoom>=16] { line-width:4; }
    }
    [class='street_limited'][zoom>=15], {
      line-join:round;
      #road, #bridge { line-cap: round; }
      [zoom>=15] { line-width:2.5; line-color:lighten(@water, 8); }
      [zoom>=16] { line-width:4; }
    }
    [class='service'][zoom>=16], {
      line-join:round;
      #road, #bridge { line-cap: round; }
      [zoom>=16] { line-width:2; line-color:@water; }
    }
    [class='major_rail'] {
      line-width: 0.4;
      line-color: @line;
